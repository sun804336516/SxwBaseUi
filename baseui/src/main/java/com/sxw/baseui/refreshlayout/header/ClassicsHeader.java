package com.sxw.baseui.refreshlayout.header;
...
import com.sxw.baseui.refreshlayout.internal.ArrowDrawable;
import com.sxw.baseui.refreshlayout.internal.InternalClassics;
import com.sxw.baseui.refreshlayout.internal.ProgressDrawable;
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public ClassicsHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lpUpdateText.topMargin = ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextTimeMarginTop, ViewUtils.dp2px(0));
        lpProgress.rightMargin = ta.getDimensionPixelSize(R.styleable.ClassicsFooter_srlDrawableMarginRight, ViewUtils.dp2px(20));
        ...
        if (ta.hasValue(R.styleable.ClassicsHeader_srlTextSizeTitle)) {
            mTitleText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextSizeTitle, ViewUtils.dp2px(16)));
        } else {
            mTitleText.setTextSize(16);
        }

        if (ta.hasValue(R.styleable.ClassicsHeader_srlTextSizeTime)) {
            mLastUpdateText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextSizeTime, ViewUtils.dp2px(12)));
        } else {
...
//    }
    ...
    public ClassicsHeader setAccentColorId(int colorId) {
        mLastUpdateText.setTextColor(ContextCompat.getColor(getContext(),colorId));
        return super.setAccentColorId(colorId);
    }
...
//    }
    ...
    public ClassicsHeader setTextTimeMarginTop(float dp) {
        ...
        lp.topMargin = ViewUtils.dp2px(dp);
