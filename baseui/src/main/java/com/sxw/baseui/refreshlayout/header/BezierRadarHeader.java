...
import com.sxw.baseui.refreshlayout.internal.InternalAbstract;
...
//    protected ValueAnimator mRadarAnimator;
    ...
    public BezierRadarHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDotRadius = ViewUtils.dp2px(7);
        mRadarRadius = ViewUtils.dp2px(20);
        mRadarCircle = ViewUtils.dp2px(7);
        mPaint.setStrokeWidth(ViewUtils.dp2px(3));

        thisView.setMinimumHeight(ViewUtils.dp2px(100));
...
//        }
    ...
    protected void drawDot(Canvas canvas, int width, int height) {
        if (mDotAlpha > 0) {
            ...
            final int num = 7;
            float x = ViewUtils.px2dp(height);
