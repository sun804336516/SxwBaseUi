package com.sxw.baseui.refreshlayout.internal;
...
//    protected SpinnerStyle mSpinnerStyle = SpinnerStyle.Translate;
    ...
    public InternalClassics(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        RelativeLayout.LayoutParams lpArrow = new RelativeLayout.LayoutParams(ViewUtils.dp2px(20), ViewUtils.dp2px(20));
        ...
        if (thisView.getPaddingTop() == 0) {
            if (thisView.getPaddingBottom() == 0) {
                thisView.setPadding(thisView.getPaddingLeft(), mPaddingTop = ViewUtils.dp2px(20), thisView.getPaddingRight(), mPaddingBottom = ViewUtils.dp2px(20));
            } else {
                thisView.setPadding(thisView.getPaddingLeft(), mPaddingTop = ViewUtils.dp2px(20), thisView.getPaddingRight(), mPaddingBottom = thisView.getPaddingBottom());
            }
        } else {
            if (thisView.getPaddingBottom() == 0) {
                thisView.setPadding(thisView.getPaddingLeft(), mPaddingTop = thisView.getPaddingTop(), thisView.getPaddingRight(), mPaddingBottom = ViewUtils.dp2px(20));
            } else {
...
//    }
    ...
    public T setDrawableMarginRight(float dp) {
        ...
        lpArrow.rightMargin = lpProgress.rightMargin = ViewUtils.dp2px(dp);
...
//    }
    ...
    public T setDrawableSize(float dp) {
        ...
        lpArrow.width = lpProgress.width = ViewUtils.dp2px(dp);
        lpArrow.height = lpProgress.height = ViewUtils.dp2px(dp);
        arrowView.setLayoutParams(lpArrow);
        progressView.setLayoutParams(lpProgress);
        return self();
    }
...
//    }
    ...
    public T setDrawableArrowSize(float dp) {
        final View arrowView = mArrowView;
        ViewGroup.LayoutParams lpArrow = arrowView.getLayoutParams();
        lpArrow.height = lpArrow.width = ViewUtils.dp2px(dp);
        arrowView.setLayoutParams(lpArrow);
        return self();
    }
...
//    }
    ...
    public T setDrawableProgressSize(float dp) {
        final View progressView = mProgressView;
        ViewGroup.LayoutParams lpProgress = progressView.getLayoutParams();
        lpProgress.height = lpProgress.width = ViewUtils.dp2px(dp);
        progressView.setLayoutParams(lpProgress);
        return self();
    }
