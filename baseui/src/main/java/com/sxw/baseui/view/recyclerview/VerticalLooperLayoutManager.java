...
/**
 * 作者：Administrator on 2019/6/10 14:54
 * 自定义layoutmanager 实现RecyclerView循环滚动
 */
public class VerticalLooperLayoutManager extends RecyclerView.LayoutManager {
    private static final String TAG = "VerticalLooper";
    private boolean looperEnable = true;

    public VerticalLooperLayoutManager() {
    }
    ...
    public int scrollVerticallyBy(int dy, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        //2.滚动
        offsetChildrenVertical((int) (travl * -0.4f));
