...
public class QTabView extends TabView {
    ...
    private void initTitleView() {
        ...
        mTitle.setTextSize(isChecked() ? mTabTitle.getTitleTextSizeSelected() : mTabTitle.getTitleTextSizeNormal());
        mTitle.setTypeface(isChecked() ? mTabTitle.getTypeFaceSelected() : mTabTitle.getTypeFaceNormal());
    ...
    private void refreshDrawablePadding() {
        int iconResid = mChecked ? mTabIcon.getSelectedIcon() : mTabIcon.getNormalIcon();
        if (iconResid != 0 || !TextUtils.isEmpty(mTabTitle.getContent())) {
    ...
    public QTabView setDividerBean(DividerBean dividerBean) {
        mDividerBean = dividerBean;
        return this;
    }
