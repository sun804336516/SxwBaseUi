...
import com.sxw.baseui.view.recyclerview.stickydecoration.cache.StickyCacheUtil;
import com.sxw.baseui.view.recyclerview.stickydecoration.listener.OnGroupClickListener;
import com.sxw.baseui.view.recyclerview.stickydecoration.listener.PowerGroupListener;
...
public class PowerfulStickyDecoration extends BaseDecoration {
     ...
     * 缓存图片
     */
    private StickyCacheUtil<Bitmap> mBitmapCache = new StickyCacheUtil<>();

    /**
     * 缓存View
     */
    private StickyCacheUtil<View> mHeadViewCache = new StickyCacheUtil<>();
    ...
    private void measureAndLayoutView(View groupView, int left, int right) {
        ...
        if (layoutParams == null) {
            layoutParams = new ViewGroup.LayoutParams(right, mGroupHeight);
        } else {
            layoutParams.height = mGroupHeight;
            layoutParams.width = right;
        }
        groupView.setLayoutParams(layoutParams);
        groupView.measure(View.MeasureSpec.makeMeasureSpec(right, View.MeasureSpec.EXACTLY),
    ...
    private void setClickInfo(View groupView, int parentLeft, int parentBottom, int position) {
        ...
        List<View> viewList = ViewUtils.getChildViewWithId(groupView);
    ...
    public static class Builder {
         ...
         * @return this
         */
        public PowerfulStickyDecoration.Builder setLineMargin(int leftMargin) {
            mDecoration.mLineMargin = leftMargin;
            return this;
        }
