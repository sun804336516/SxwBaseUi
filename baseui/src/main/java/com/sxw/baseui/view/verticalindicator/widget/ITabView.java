...
public interface ITabView {
    ...
    class TabTitle {
        ...
        public int getTitleTextSizeSelected() {
            return mBuilder.mTitleTextSizeSelected;
        }

        public int getTitleTextSizeNormal() {
            return mBuilder.mTitleTextSizeNormal;
        }

        public Typeface getTypeFaceSelected() {
            return mBuilder.mTypefaceSelected;
        }

        public Typeface getTypeFaceNormal() {
            return mBuilder.mTypefaceNormal;
        }
        ...
        public static class Builder {
            ...
            private int mTitleTextSizeSelected;
            private int mTitleTextSizeNormal;
            ...
            public Builder() {
                ...
                this.mTitleTextSizeSelected = 16;
                this.mTitleTextSizeNormal = 16;
                mTypefaceSelected = Typeface.DEFAULT;
                mTypefaceNormal = Typeface.DEFAULT;
                this.mContent = "";
            }
            ...
            public Builder setTextSize(int sizeSelected, int sizeNormal) {
                mTitleTextSizeSelected = sizeSelected;
                mTitleTextSizeNormal = sizeNormal;
                return this;
            }

            public Builder setTypeface(Typeface typefaceSelected, Typeface typefaceNormal) {
                mTypefaceSelected = typefaceSelected;
