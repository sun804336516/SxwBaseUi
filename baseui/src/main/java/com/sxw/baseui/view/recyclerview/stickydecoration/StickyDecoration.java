...
import com.sxw.baseui.view.recyclerview.stickydecoration.listener.GroupListener;
...
public class StickyDecoration extends BaseDecoration {
    ...
    private int mSideMargin = 0;   //边距 左边距
...
//    }
    ...
    protected String getGroupName(int position) {
        if (mGroupListener != null) {
            return mGroupListener.getGroupName(position + mHeaderCount);
        } else {
            return null;
        }
    }
    ...
    public static class Builder {
         ...
         * @return this
         */
        public Builder setLineMargin(int leftMargin) {
