...
public class RecyclerViewItemAnimator extends SimpleItemAnimator {
    ...
    protected ArrayList<ArrayList<ViewHolder>> mAdditionsList = new ArrayList<>();
...
//        ViewCompat.setRotationY(oldHolder.itemView, 0);
...
//            ViewCompat.setRotationX(newHolder.itemView, 0);
        }
...
//                    .rotationY(360)
        ...
        if (newView != null) {
            final ViewPropertyAnimatorCompat newViewAnimation = ViewCompat.animate(newView).setDuration(getChangeDuration());
...
//                    .rotationX(360)
    ...
    public void endAnimation(ViewHolder item) {
        ...
        // TODO if some other animations are chained to end, how do we cancelRequest them as well?
        ...
        // animations should be ended by the cancelRequest above.
     ...
     * CatViewHolder arguments will be the same instance.
     * </li>
     * <li>
